package PracticeIrinaZ.takeout.utils;

import static PracticeIrinaZ.takeout.utils.PrintUtils.CommonPrintMethods.*;

public class PrintUtils {

    private final static String LINE = "_________________________________________________";
    ...
    public static class PrintTitles {
        public static void printMenuTitle() {
            println();
            println();
            print("________________Take Out Menu ______________");
            println();
            println();
        }
        public static void printMainDishesTitles() {
            print(MAIN_DISHES_TITLE);
            println();
            println();
        }
        public static void printSidesTitles() {
            print("Our Healthy Sides: ");
            println();
            println();
        }
        public static void printDrinksTitles() {
            print("Drinks: ");
            println();
            println();
        }
